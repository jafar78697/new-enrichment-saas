...
// 1. Update LeadOutcome and LeadFilter types
...
// 2. Add clearingAll state
content = content.replace(
  "const [deletingLeadId, setDeletingLeadId] = useState<number | null>(null);",
  "const [deletingLeadId, setDeletingLeadId] = useState<number | null>(null);\n  const [clearingAll, setClearingAll] = useState(false);"
);

// 3. Update filteredContacts logic
content = content.replace(
...
// 5. Add Delete All Leads button near Import Leads
content = content.replace(
  `            <button
...
// 6. Update Filter UI to be a dropdown
content = content.replace(
...
// 7. Add Voicemail indicator to lead card
content = content.replace(
...
// 8. Update outcome buttons in notes
content = content.replace(
  `{([
