...
export default function Overview() {
  return (
    <div className="prose prose-invert prose-indigo max-w-none">
      <h1 className="text-4xl font-extrabold tracking-tight text-white mb-4">Jento Calling Overview</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        <div className="bg-surface/40 border border-border/50 rounded-xl p-6">
          <h3 className="text-lg font-bold text-white mb-2">Automated Dialer</h3>
        ...
        <div className="bg-surface/40 border border-border/50 rounded-xl p-6">
          <h3 className="text-lg font-bold text-white mb-2">Live Transcription</h3>
          <p className="text-textMuted text-sm">
        ...
        <div className="bg-surface/40 border border-border/50 rounded-xl p-6">
          <h3 className="text-lg font-bold text-white mb-2">Lead Enrichment</h3>
          <p className="text-textMuted text-sm">
      ...
      <h2 className="text-2xl font-bold text-white mb-4 mt-8">Why Jento Calling?</h2>
