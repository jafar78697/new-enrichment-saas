...
CREATE INDEX IF NOT EXISTS idx_contacts_agent_id ON contacts(assigned_agent_id);
CREATE INDEX IF NOT EXISTS idx_niches_agent_id ON niches(assigned_agent_id);
