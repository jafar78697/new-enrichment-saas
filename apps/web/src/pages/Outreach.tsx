...
export default function OutreachPage() {
  ...
  const [activeTab, setActiveTab] = useState<'email' | 'facebook' | 'linkedin' | 'reddit' | 'settings'>('email');
      ...
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-8">
          ...
          <button
            ...
            } flex items-center whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm ml-auto`}
          >
