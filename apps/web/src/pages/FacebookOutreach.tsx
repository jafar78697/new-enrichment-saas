...
export default function FacebookOutreach() {
  ...
  return (
    <div className="space-y-6">
      <Link to="/outreach" className="text-indigo-600 font-medium hover:underline inline-block">
        ← Back to Outreach Hub
      </Link>

      {/* Platform Toggle Header */}
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Facebook / Instagram Auto-Pilot</h1>
        ...
        <div className="flex bg-gray-100 p-1 rounded-xl shadow-inner">
          ...
          <button
            ...
            style={platform === 'instagram' ? { color: '#E1306C' } : {}}
          >
            {/* Instagram Icon */}
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 overflow-hidden">
        {platform === 'facebook' ? (
          <FacebookDashboard platform="facebook" />
        ) : (
          <InstagramDashboard />
        )}
      </div>
