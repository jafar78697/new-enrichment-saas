    ...
    <div className="landing-shell">
      ...
      <header className="landing-topbar">
        <div className="landing-topbar-inner">
          <Link to="/" className="landing-brand">
            <img src="/favicon.png" alt="Enrichment Sys" style={{ width: 36, height: 36, borderRadius: 8, objectFit: 'cover' }} />
          ...
          <div className="landing-actions">
            {token ? (
              ...
              <>
                <Link to="/login" className="landing-secondary-button" style={{ marginRight: 16 }}>
                  Log In
                </Link>
      ...
      <main className="landing-main">
        ...
        <footer className="mt-20 py-8 border-t border-gray-200 text-center text-gray-500 text-sm">
          <p>© 2026 Enrichment Sys. All rights reserved.</p>
